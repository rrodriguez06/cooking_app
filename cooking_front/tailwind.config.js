  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Marque (paprika chaud) — le token `primary` est recoloré : les usages
        // existants bg-primary-*/text-primary-*/ring-primary-* adoptent le nouveau brand.
        primary: {
      ...
      boxShadow: {
        soft: '0 2px 12px rgba(23, 16, 10, 0.06)',
        'soft-lg': '0 10px 34px rgba(23, 16, 10, 0.10)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
