...
import { Calendar, Clock, Users, Search, ChefHat } from 'lucide-react';
            ...
            <div>
              ...
              {recipes.length > 0 && (
                <div className="space-y-3">
                  <h3 className="font-medium text-foreground">Résultats de recherche</h3>
                  <div className="grid gap-3">
                    {recipes.map((recipe) => (
                      <div
                        key={recipe.id}
                        onClick={() => handleRecipeSelect(recipe)}
                        className="flex items-center space-x-3 p-3 border border-border rounded-lg hover:border-primary/30 hover:bg-primary/10 cursor-pointer transition-colors"
                      >
                ...
                <div className="mb-6 p-4 border border-border rounded-lg bg-muted/50">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-foreground">{selectedRecipe.title}</h3>
